...
const Profile = () => {
    ...
    const [avatarUrl, setAvatarUrl] = useState("/default_dog.png")
    const { user } = useStore()
    ...
    const onUploadImage = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (fileType !== "image/jpeg" && fileType !== "image/png" ) {
            setFileMessage("画像はJPEGまたはpng形式にしてください")
            return
        }
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                {/*アバター画像 */}
                <div className="mb-5">
                    <div className="flex flex-col text-sm item-center justify-center mb-5">
                ...
                <div className="mb-5">
                    ...
                    <input
                        type="text"
                        className="border rounded-md w-ful py-2 px-3 focus:outline-none focus:border-sky-500"
                        placeholder="名前"
                        id="name"
                ...
                {/*紹介文*/}
                <div className="mb-5">
                    <div className="text-sm mb-1 font-bold">紹介文</div>
                    <input
                        type="text"
                        className="border rounded-md w-ful py-2 px-3 focus:outline-none focus:border-sky-500"
                        placeholder="紹介文"
            ...
            {/*メッセージ*/}
            {message && <div className="my-3 text-center text-sm text-red-500 mb-5">{message}</div>}
        </div>
    )
